...
userSchema.pre("deleteOne",function(next){
    console.log(this.Name,"is getting deleted");
    next();
})
// MiddleWare
...
const insertMultiUser = async(AllNewUsers)=>{

    const users = await User.insertMany(AllNewUsers,opts);
    console.log(users);
...
// insertMultiUser([{Name:"jim",age:20,email:"jim@abc.com"},{Name:"ram",age:18,email:"ram@abc.com"},{Name:"shiva",age:24,email:"shiva@abc.com"}])

const deleteUser = async (deleteFilter)=>{
    const res = await User.deleteOne(deleteFilter,opts);
